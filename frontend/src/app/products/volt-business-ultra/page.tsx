    ...
    <div className={styles.page}>
            ...
            <div className={styles.heroLeft}>
              ...
              <AnimateIn direction="left" delay={4}>
                <p className={styles.description}>
                  The VoltBusiness Ultra is our ultimate flagship EV charger — combining every premium feature 
        ...
        <div className="container">
          <div className={styles.splitGrid}>
            <div className={styles.imageShowcaseWrap}>
              <img src="/ultra2.png" alt="VoltBusiness Ultra In Action" className={styles.showcaseStaticCharger} />
            </div>
            <div className={styles.splitTextCol}>
              ...
              <p className={styles.sectionDesc}>
                VoltBusiness Ultra brings together every advanced BexaVolt technology into a single premium unit — 
      ...
      <section className={styles.sectionPadding}>
        <div className="container">
          <div className={styles.splitGrid}>
            ...
            <div className={styles.imageShowcaseWrap}>
              <img src="/ultra3.png" alt="VoltBusiness Ultra Charging" className={styles.showcaseStaticCharger} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className={styles.splitGrid}>
            <div className={styles.appShowcaseCol}>
              <img src="/ultra4.png" alt="VoltBusiness Ultra App" className={styles.appShowcaseImage} />
            </div>
            <div className={styles.splitTextCol}>
              ...
              <p className={styles.sectionDesc}>
                The BexaVoltBusiness Ultra app experience gives you access to every feature — from solar routing 
          ...
          <div className={styles.warrantyBanner}>
            ...
            <div className={styles.warrantyContent}>
              ...
              <p className={styles.warrantyDesc}>
                VoltBusiness Ultra comes standard with our exclusive 5-year comprehensive warranty — the longest 
      ...
      <section className={styles.bottomCtaSection}>
        <div className="container">
          ...
          <p>Get a standalone VoltBusiness Ultra or arrange a complete professional home installation today.</p>
