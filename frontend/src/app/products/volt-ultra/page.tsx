    ...
    <div className={styles.page}>
            ...
            <div className={styles.heroLeft}>
              ...
              <AnimateIn direction="left" delay={4}>
                <p className={styles.description}>
                  The Volt Ultra is our ultimate flagship EV charger — combining every premium feature 
          ...
          <div className={styles.splitGrid}>
            ...
            <div className={styles.splitTextCol}>
              ...
              <p className={styles.sectionDesc}>
                Volt Ultra brings together every advanced BexaVolt technology into a single premium unit — 
        ...
        <div className="container">
          <div className={styles.splitGrid}>
            ...
            <div className={styles.splitTextCol}>
              ...
              <p className={styles.sectionDesc}>
                The BexaVolt Ultra app experience gives you access to every feature — from solar routing 
      ...
      <section className={styles.bottomCtaSection}>
        <div className="container">
          ...
          <p>Get a standalone Volt Ultra or arrange a complete professional home installation today.</p>
